        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="7" style="background-color: #353535;">
            ...
            <tr id="news_${nw.getIdNews()}">
                <td width=100% colspan="2" style="background-color: #2c2c2c; text-align: left" id="title_${nw.getIdNews()}">
                    ...
                    <a class="ui" href="#" style="color: white" onclick="return editNews(1,${nw.getIdNews()});" id="news_edit_${nw.getIdNews()}">[Edit]</a>
                    <a class="ui" href="#" onclick="return deleteNews(${nw.getIdNews()});" style="color: white" >[Delete]</a>
                    </c:if>
                </td>
            </tr>
            <tr>
                <td width=100% style="text-align: left" id="body_${nw.getIdNews()}">
                    ...
                    <input type="hidden" value="${nw.getBody()}" id="news_body_${nw.getIdNews()}">
                            <c:if test="${userInfo.getUserClass() == 2 || userInfo.getUserClass() > 4}">
                <div style="text-align: center; margin-top: 3pt"><a class="ui" href="#" style="color: #99ccff;" onclick=" return editNews(2,${nw.getIdNews()}); " id="news_edit_body_${nw.getIdNews()}">[Edit]</a></div>
                            </c:if>
                </td>
            </tr>
            ...
            <c:if test="${userInfo.getUserClass() == 2 || userInfo.getUserClass() > 4}">
            <a href="#newsform" style="color: #99ccff; text-decoration: none;" onclick="return addNewsForm(${userInfo.getIdSerie()});" id="newsform">-- Add announcement --</a>
            </c:if>
            ${sessionScope.error}
